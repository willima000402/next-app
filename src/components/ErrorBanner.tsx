        ...
        <div>
          ...
          {isApiKeyError ? (
            <div className="text-sm text-red-700 space-y-1">
              ...
              <p>
                Add <code className="bg-red-100 px-1 rounded font-mono text-xs">OPENAI_API_KEY=your_key</code> to your{" "}
                <code className="bg-red-100 px-1 rounded font-mono text-xs">.env.local</code> file and restart the dev server.
              </p>
            </div>
          ) : (
